...
class Response:
    ...
    def __init__(self, request, tables):
        ...
        #print 'response request.function_code:',request.function_code
    ...
    def create_pdu_fc03(self):
        ...
        # read data from config
        for i in range(self.request.start_reference, self.request.start_reference + self.request.register_count):
            #print 'i:',i
